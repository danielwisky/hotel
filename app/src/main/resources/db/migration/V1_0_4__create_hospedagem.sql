CREATE TABLE `hospedagem` (
  ...
  CONSTRAINT `FK_HOSPEDAGEM_ACOMODACAO` FOREIGN KEY (`acomodacao_id`) REFERENCES `acomodacao` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_HOSPEDAGEM_HOSPEDE` FOREIGN KEY (`hospede_id`) REFERENCES `hospede` (`id`) ON DELETE CASCADE
