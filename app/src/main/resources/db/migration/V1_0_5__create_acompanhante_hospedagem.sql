CREATE TABLE `acompanhante_hospedagem` (
  ...
  CONSTRAINT `FK_ACOMPANHANTE_HOSPEDAGEM` FOREIGN KEY (`hospedagem_id`) REFERENCES `hospedagem` (`id`), 
  CONSTRAINT `FK_HOSPEDAGEM_ACOMPANHANTE` FOREIGN KEY (`acompanhante_id`) REFERENCES `acompanhante` (`id`)
